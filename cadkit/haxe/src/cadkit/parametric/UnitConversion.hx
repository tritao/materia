...
class UnitConversion {
	public static function canonicalUnit(kind:String):String {
		return switch QuantityKind.validate(kind) {
			case QuantityKind.Length: "mm";
			case QuantityKind.Angle: "rad";
			case QuantityKind.Count: "count";
			case QuantityKind.Area: "mm2";
			case QuantityKind.Volume: "mm3";
			default: "1";
		};
	}
	...
	public static function toCanonical(value:Float, kind:String, unit:String):Float {
		...
		if (kind == QuantityKind.Count && result != Std.int(result))
