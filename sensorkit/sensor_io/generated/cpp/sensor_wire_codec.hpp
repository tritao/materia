...
void write(::nksensor::wire::detail::MessagePackWriter &, const PackedFrameMessage &);
bool read(::nksensor::wire::detail::MessagePackReader &, PackedFrameMessage &, std::string *error);
void write(::nksensor::wire::detail::MessagePackWriter &, const ImuSampleMessage &);
bool read(::nksensor::wire::detail::MessagePackReader &, ImuSampleMessage &, std::string *error);
void write(::nksensor::wire::detail::MessagePackWriter &, const LidarScanMessage &);
