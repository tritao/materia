...
for test_artifact in \
    "$build_dir/nativekit/tests/nativekit_platform_parity.html" \
    "$build_dir/nativekit/tests/nativekit_web_accessibility.html" \
    "$build_dir/nativekit/tests/nativekit_web_system_equivalents.html"; do
