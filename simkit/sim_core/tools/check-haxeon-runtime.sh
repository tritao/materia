...
native_build=${NKSIM_SHARED_BUILD_DIR:-"$repo_dir/../../nativekit-builds/sim-core-shared"}
...
library_path="$native_build:$native_build/modules/scene:$native_build/modules/sim_core:$haxeon_dir/out:$haxeon_dir/.tools/hashlink"
